...
AI_EXTRACTION_BATCH_SIZE = int(os.getenv('AI_EXTRACTION_BATCH_SIZE', '15'))
AI_TRIAGE_MAX_CONCURRENT = int(os.getenv('AI_TRIAGE_MAX_CONCURRENT', '3'))
AI_EXTRACTION_MAX_CONCURRENT = int(os.getenv('AI_EXTRACTION_MAX_CONCURRENT', '2'))
AI_RATE_LIMIT_TOKENS_PER_MIN = int(os.getenv('AI_RATE_LIMIT_TOKENS_PER_MIN', '40000'))
